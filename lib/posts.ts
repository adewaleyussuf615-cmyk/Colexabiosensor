...
export const demoPosts: Post[] = [
  ...
  {
    id: '5',
    slug: 'onpoint-gh82-monitoring-system',
    title: 'OnPoint GH82 Monitoring System',
    category: 'Product Info',
    excerpt: 'Product information for the OnPoint GH82 Blood Glucose Monitoring System, designed for everyday glucose monitoring.',
    body: `<h2>Product information</h2><p>The OnPoint GH82 Monitoring System is designed to support quantitative blood glucose measurement using fresh capillary whole blood in home health routines and clinical settings.</p><p>Use the system according to its instructions for use and follow guidance from your healthcare professional when interpreting results.</p>`,
    featured_image: 'https://colexabiosensor.com/wp-content/uploads/2025/03/OnPoint-Strip-image-e1742123798188.png',
    author: 'Colexa Biosensor',
  ...
  {
    id: '6',
    slug: 'onpoint-gh82-test-strip',
    title: 'OnPoint GH82 Test Strip',
    category: 'Product Info',
    excerpt: 'Product information for the OnPoint GH82 Test Strip, used with the OnPoint GH82 monitoring system.',
    body: `<h2>Product information</h2><p>The OnPoint GH82 Test Strip is intended for quantitative measurement of glucose in fresh capillary whole blood when used with the OnPoint GH82 Blood Glucose Monitoring System.</p><p>Refer to the product instructions for handling, storage and use requirements.</p>`,
    featured_image: 'https://colexabiosensor.com/wp-content/uploads/2025/03/OnPoint-Strip-image-2.png',
    author: 'Colexa Biosensor',
